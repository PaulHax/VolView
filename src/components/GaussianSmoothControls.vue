<template>
  <div class="mb-2 d-flex align-center">
    <mini-expansion-panel>
      <template #title> Smooth the selected segment using Gaussian filtering. </template>
      <ul>
        <li>
        ...
        <li>
          Background pixels may be added to the segment where confidence is high enough.
        </li>
      </ul>
    </mini-expansion-panel>
  </div>
