<template>
  <div class="d-flex align-center">
    <mini-expansion-panel>
      ...
      <ul>
        <li>
          Applies label-preserving Gaussian smoothing to reduce noise and smooth boundaries.
        </li>
        <li>Each label is processed separately to prevent mixing between different segments.</li>
        <li>
          Higher sigma values create more smoothing effect but may reduce fine details.
        </li>
      </ul>
    </mini-expansion-panel>
  </div>
