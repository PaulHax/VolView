// ---------------------------------------------------------------------------
// Task-spec envelope validation (contract Seam 2 — task description; D2).
//
...
// format. It consumes the published `processing-contract` package verbatim; it
...
// unknown parameter kind (Chunk 5 negative fixture). But the engine must fail
...
import { z } from 'zod';
import { taskSpecSchema } from '@/processing-contract';
